...
async function fetchCiTime(filePath) {
  const url = `https://api.github.com/repos/imwyz/weekly/commits?path=${filePath}&page=1&per_page=1`;
...
async function main() {
  const readmeContent = "# 彦祖周刊\n\n> 记录工程师 彦祖 的不枯燥生活，欢迎订阅，也欢迎 [推荐](https://github.com/tw93/weekly/discussions/22) 你的好东西，Fork 自用可见 [开发文档](https://github.com/tw93/weekly/blob/main/Deploy.md)，期待你玩得开心~\n\n";
  ...
  for (let i = 0; i < mdFiles.length; i++) {
    ...
    const url = `https://wyz.im/posts/${oldTitle}`;
